...
import { AjaxError, UnauthorizedError, InvalidError, ForbiddenError } from '../errors';
  ...
  request: function request(url, options) {
    ...
    return new Ember.RSVP.Promise(function (resolve, reject) {
      ...
      hash.success = function (payload, textStatus, jqXHR) {
        var response = _this.handleResponse(jqXHR.status, parseResponseHeaders(jqXHR.getAllResponseHeaders()), payload);
      ...
      hash.error = function (jqXHR, textStatus, errorThrown) {
        ...
        if (!(error instanceof Error)) {
          if (errorThrown instanceof Error) {
            ...
            error = _this.handleResponse(jqXHR.status, parseResponseHeaders(jqXHR.getAllResponseHeaders()), _this.parseErrorResponse(jqXHR.responseText) || errorThrown);
          }
        }
        reject(error);
      };
