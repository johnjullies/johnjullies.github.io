...
import { InvalidError } from 'ember-data/-private/adapters/errors';
...
Store = Service.extend({
  ...
  */
  findByIds: function findByIds(modelName, ids) {
    ...
    return promiseArray(Ember.RSVP.all(ids.map(function (id) {
  ...
  */
  ...
  _pushInternalModel: function _pushInternalModel(data) {
    ...
    if (Ember.ENV.DS_WARN_ON_UNKNOWN_KEYS) {
      warn("The payload for '" + type.modelName + "' contains these unknown keys: " + Ember.inspect(Object.keys(data).forEach(function (key) {
